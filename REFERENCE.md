...
interface RepeatOpts {
  ...
  every?: number; // Repeat every millis within the nearest interval of length "every" (cron or everyMillis setting cannot be used together with this setting.)
  everyMillis?: number; // Repeat every millis (cron or every setting cannot be used together with this setting.)
